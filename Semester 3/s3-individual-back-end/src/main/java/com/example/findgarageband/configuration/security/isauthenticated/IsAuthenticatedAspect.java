package com.example.findgarageband.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(com.example.findgarageband.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(com.example.findgarageband.configuration.security.isauthenticated.IsAuthenticated)")
