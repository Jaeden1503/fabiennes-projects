...
class GetCommentsByUserUCImplTest {
    @Mock
    private CommentRepository commentRepositoryMock;
    @Mock
    private AccessTokenValidator accessTokenValidator;
    @InjectMocks
    private GetCommentsByUserUCImpl getCommentsByUserUC;

    @Test
    void getAllCommentsByUser_shouldReturnAllComments() {
        ...
        when(commentRepositoryMock.findCommentsByUserId(1L)).thenReturn(commentList);

        GetAllCommentsResponse actualResponse = getCommentsByUserUC.getCommentsByUserId(1L);
        ...
        verify(commentRepositoryMock).findCommentsByUserId(1L);
    }
}