package com.example.siouxmanagementsystem.configuration.security.isauthenticated;
...
public class IsAuthenticatedAspect {
    ...
    @Pointcut("@annotation(com.example.siouxmanagementsystem.configuration.security.isauthenticated.IsAuthenticated)")
    public void annotatedMethod() {
    }

    @Pointcut("@within(com.example.siouxmanagementsystem.configuration.security.isauthenticated.IsAuthenticated)")
